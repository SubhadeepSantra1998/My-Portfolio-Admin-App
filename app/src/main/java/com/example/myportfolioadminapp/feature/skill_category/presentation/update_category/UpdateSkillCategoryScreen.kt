        ...
        Column(
            ...
            Column(
                ...
                CheckboxComponents(
                    ...
                    text = if (uiState.status) "I want to keep this category visible" else "I don't want to keep this category visible",
                ...
                PrimaryButtonComponent(
                    modifier = Modifier
                        .fillMaxWidth(),
                    text = "Update",
                    enabled = uiState.isInputValidated,
                    onClick = {
